...
class _TeacherAddAnnouncementScreenState extends State<TeacherAddAnnouncementScreen> {
  ...
  final List<String> _audienceOptions = ['all', 'student'];
  ...
  final List<String> _announcementTypes = ['academic', 'event', 'urgent', 'important'];
  ...
  Future<void> _saveAnnouncement() async {
    ...
    try {
      ...
      final success = await announcementService.createAnnouncement(announcement);
