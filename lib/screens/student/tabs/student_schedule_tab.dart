...
class _StudentScheduleTabState extends State<StudentScheduleTab> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadSchedules() async {
    try {
      ...
      // Assuming student class ID is stored in the User model
      final schedules = await _scheduleService.getClassSchedule(widget.user.classId!);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.person, 'Guru: ${schedule.teacherName}'),
